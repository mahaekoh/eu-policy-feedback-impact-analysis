...
### Before/after analysis files (`before_after_analysis_v3/*.json`)

One JSON file per analysed initiative (118 files) with the data restructured for comparison:
...
### AI-generated summaries (`summaries_output_v8/*.json`)
...
| Initiatives with documents after feedback | 118 |
