...
Each document and feedback attachment in the before/after analysis can be enriched with a `summary` field: a detailed summary (up to 20 paragraphs) generated by a 120-billion-parameter language model.
