...
Each document and feedback attachment in the before/after analysis can be enriched with a `summary` field: a detailed summary (up to 10 paragraphs per chunk, up to 20 when combined) generated by a 120-billion-parameter language model.
