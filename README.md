...
Each document and feedback attachment in the before/after analysis can be enriched with a `summary` field: a structured summary (5 paragraphs for Commission documents, up to 5 paragraphs for feedback) generated by a 120-billion-parameter language model.
...
For a complete technical breakdown of each pipeline component, dependencies, data schemas, and instructions for running the pipeline, see [TECHNICAL.md](TECHNICAL.md).
